...
const DUST_DATA = [
  ...
  { label: "Transformer — No AOD", clean: 97e-4, dust: 0.0331, penalty: 242.8 },
  { label: "Transformer — AOD", clean: 0.0105, dust: 0.0372, penalty: 256 },
...
function Home() {
  reactExports.useEffect(() => {
    ...
    if (container && container.childElementCount === 0) {
      const maxVal = 0.2;
      DUST_DATA.forEach((d) => {
        const penaltyColor = d.penalty > 200 ? "#E07060" : d.penalty > 100 ? "#D4A060" : "#7BB88C";
        container.innerHTML += `
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "home-root", dangerouslySetInnerHTML: {
      __html: HOME_BODY
    } })
  ] });
}
